...
export const BloqueConIcono = component$<BloqueConIconoProps>((props) => {
  return (
    <div class="flex gap-3 bg-slate-200 p-3 shadow-md rounded-lg mb-2">
      <div class="w-1/7 lg:w-1/6 m-auto px-1">
        <Slot />
      </div>
